...
// It seems really weird that a 2in circuit works on a tree depth of 42 but a 4in circuit does not even work on tree depth 3 :/
...
//                     //deploymentBlock,
//                     //blocksPerGetLogsReq
//                     circuitSize:4 // we only use one burn account but we can pretend we did 4. No-one wil know hehe
//                 })
