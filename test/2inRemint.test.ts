...
describe("Token", async function () {
    ...
    beforeEach(async function () {
        ...
        wormholeToken = await viem.deployContract(WormholeTokenContractName, [PrivateTransferVerifier2In.address, PrivateTransferVerifier100In.address], { client: { wallet: deployer }, libraries: { leanIMTPoseidon2: leanIMTPoseidon2.address } },);
